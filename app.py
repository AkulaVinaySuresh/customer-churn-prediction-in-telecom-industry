...
def predict_api():
    ...
    Online_Backup = int(api_data['online_backup'])
    ...
    data = [Latitude, Longitude, Senior_Citizen, Online_Security, Online_Backup, Tech_Support, Paperless_Billing, Age, Under_30, Married,
        Population, Total_Revenue, Satisfaction_Score, Tenure_Bins__0_12_, Tenure_Bins__12_24_, Tenure_Bins__24_48_,
...
def predict():
    ...
    pred = "Churn" if output_probab > 0.4 else "Continue"
